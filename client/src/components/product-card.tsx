...
const bgTones = [
  ...
  "bg-gradient-to-br from-warmGray-200 via-stone-300 to-neutral-200 dark:from-stone-700 dark:via-neutral-800 dark:to-stone-700",
];
...
export function ProductCard({ product }: { product: Product }) {
  ...
  return (
    ...
    >
      <div className="aspect-square w-full overflow-hidden rounded-lg mb-3 relative">
        {product.imageUrl ? (
          <img
