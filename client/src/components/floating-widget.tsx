      ...
      >
        ...
        <div className="relative w-full">
          ...
          <div className="absolute inset-0 rounded-xl pointer-events-none">
            <span className="absolute font-black text-black tracking-wider text-center bg-white rounded px-2 py-1 w-full block" style={{top:'15%', fontSize:'15.4px'}}>SET PRICE</span>
            ...
            <span className="absolute font-black text-black tracking-wider text-center bg-white rounded px-2 py-1 w-full block" style={{top:'55%', fontSize:'15.4px'}}>SHARE</span>
          </div>
        </div>
      </div>
    );
